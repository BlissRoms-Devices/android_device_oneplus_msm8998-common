...
public class FPSTileService extends TileService {
  ...
  public void onStartListening() {
      ...
      for (ActivityManager.RunningServiceInfo service :
          ...
          if (com.bliss.device.DeviceSettings.FPSInfoService.class.getName().equals(
  ...
  @Override
  public void onClick() {
      Intent fpsinfo = new Intent(this, com.bliss.device.DeviceSettings.FPSInfoService.class);
      if (!isShowing)
